...
<div class="hero ">
    <picture>
        <source srcset="https://rebellion.earth/wp/wp-content/uploads/2019/04/donate-Bannerimage.jpg" media="(min-width: 1001px)">
        <source srcset="https://rebellion.earth/wp/wp-content/uploads/2019/04/donate-Bannerimage-1000x415.jpg" media="(min-width: 601px)">
        <img src="https://rebellion.earth/wp/wp-content/uploads/2019/04/donate-Bannerimage-600x300.jpg" alt="" />
    </picture>
    <h1>Doná</h1>
</div>
        ...
        <div class="featured-text__content">
            ...
            <div class="donate-columns">
                ...
                <div class="donate-column type">
                    <div class="donate-column-text type">
                        <p>Donando mensualmente con tu tarjeta de crédito a nuestra cuenta de mercadopago para comprar materiales como tela, hilo, pintura para tela, remeras, banderas, afiches, carteles, stickers y otras cosas más.</p>
                    </div>
                    <p>
                ...
                <div class="donate-column type">
                    <div class="donate-column-text type">
                        <p>Aportando algún equipamiento que necesitamos. Ahora estamos necesitando:
                            ...
                            Un equipo de sonido bien power
