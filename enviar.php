<?php
  ...
  if ($bool) {
    ...
    <body>
      ...
      <p class="p1">Si no entraste aún te invitamos a subirte a nuestro grupo en Telegram XR Argentina</a> aca:<a href="https://t.me/joinchat/J_3jVBbvCfWRHmmlFhCYnA" target="new" rel="noopener"> XR Argentina</a></p>
